...
# 2.1.1.6 LAB: The print() function *********** (LAB 1) ***********
# Description: This LAB invokes the print function using quotes and parenthesis
print("Hello, Python!") # Uses double quotes
print("Tej") # Prints my name
print('Tej') # Uses single quotes
print() # Print a new line

# 2.1.1.18 LAB: The print() function *********** (LAB 2) ***********
# Description:  This LAB uses keyword arguments sep and end of the print function
print("Programming","Essentials","in", sep="***", end="...") # Keyword arguments sep and end are used to generated the expected output
print("Python") 
print() # Print a new line


# 2.1.1.19 LAB: Formatting the output *********** (LAB 3) ***********
# Description: The LAB formats the character output
print("    *")
print("   * *")
print("  *   *")
print(" *     *")
...
# 2.2.1.11 LAB: Python literals - strings *********** (LAB 4) ***********
# Description: This LAB make use of one-line print function to output three lines of outputs.
print('"I\'m\n""learning""\n"""Python"""') # One-line print() function which outputs three lines of expected output.
print() # Print a new line


# 2.4.1.7 LAB: Variables *********** (LAB 5) ***********
# Description: This LAB makes use of variables to calculate the total number of apples.
...
# 2.4.1.9 LAB: Variables: a simple converter *********** (LAB 6) ***********
# Description: This LAB converts miles to kilometer and vice-versa.
kilometers = 12.25
miles = 7.38
...
# 2.4.1.10 LAB: Operators and expressions *********** (LAB 7) ***********
# Description: This LAB evaluates the expression and ouput the result to the terminal.
...
#2.5.1.2 LAB: Comments *********** (LAB 8) ***********
# Description: This LAB computes the number of seconds in a given number of hours
...
# 2.6.1.9 LAB: Simple input and output *********** (LAB 9) ***********
# Description: This LAB evalueates the results of four basic arithmetic operations
...
# 2.6.1.10 LAB: Operators and expressions *********** (LAB 10) ***********
# Description: This LAB evaluates the expression below.
...
# 2.6.1.11 LAB: Operators and expressions *********** (LAB 11) ***********
# Description: This LAB evaluates the end time from the given time and duration
