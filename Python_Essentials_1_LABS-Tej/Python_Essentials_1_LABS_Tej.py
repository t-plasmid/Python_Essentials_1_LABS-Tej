# Author: Tej Kumar Rai
# Date Modified: 21/09/2021
# Description: This source file contains all the labs of Pthon Essentils 1 course.

# ******************************************************************* Start: Module 2 ******************************************************************* #
# The topics covered within this module are data types, variables, basic input-output operations and basic operators.
...
# ******************************************************************* Start: Module 3 ******************************************************************* #
# The topics covered within this module are Boolean Values, Conditional Execution, Loops, Lists and List Processing, Logical and Bitwise Operations
